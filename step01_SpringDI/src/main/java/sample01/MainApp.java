...
//        bean.sayHello("Chamsol");
        ...
        ApplicationContext context = new ClassPathXmlApplicationContext("sample01/applicationContext01.xml"); // 이게 일반적
//				new FileSystemXmlApplicationContext("src/main/java/sample01/applicationContext04.xml");
